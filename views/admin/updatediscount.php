                ...
                <div>
                    ...
                    <form method="post" onsubmit="return validateDiscountForm()">
                        <div>
                            ...
                            <input type="text" id="discount_code" name="discount_code" value="<?= $onediscount['discount_code'] ?>">
                        ...
                        <div>
                            ...
                            <input type="number" id="discount_value" name="discount_value" min="1" max="100" value="<?= $onediscount['discount_value'] ?>">
                        ...
                        <div>
                            ...
                            <input type="number" id="minimum_order" name="minimum_order" min="0" value="<?= $onediscount['minimum_order'] ?>">
                            <div class="error-message" id="error-minimum_order" style="color: red; margin-top: 5px;"></div>
                        </div>

                        <div>
                            <label for="valid_from">Ngày Bắt Đầu:</label>
                            <input type="datetime-local" id="valid_from" name="valid_from" value="<?= $onediscount['valid_from'] ?>">
                            <div class="error-message" id="error-valid_from" style="color: red; margin-top: 5px;"></div>
                        </div>

                        <div>
                            <label for="valid_to">Ngày Hết Hạn:</label>
                            <input type="datetime-local" id="valid_to" name="valid_to" value="<?= $onediscount['valid_to'] ?>">
                        ...
                        <div>
                            ...
                            <select id="status" name="status">
                                ...
                                <option value="inactive" <?= $onediscount['status'] === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                            </select>
                            <div class="error-message" id="error-status" style="color: red; margin-top: 5px;"></div>
                        </div>

                        <div>
                            <button type="submit" name="btn_update">Chỉnh sửa</button>
                        </div>
