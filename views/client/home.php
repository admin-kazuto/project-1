              ...
              <div
                ...
                <div class="item">
                  <div class="thumbnail-menu-modern">
                    ...
                    <div class="caption">
                      <h5>
                        <a class="link link-default" href="menu-single.html">French macaroons</a>
                      </h5>
                      <p class="text-italic">
                        French macaroons are thin, flavorful meringue cookies
                        that are sandwiched together with some kind of
                        filling.
                      </p>
                      <p class="price">12.50</p>
                      <a
                ...
                <div class="item">
                  <div class="thumbnail-menu-modern">
                    ...
                    <div class="caption">
                      <h5>
                        <a class="link link-default" href="menu-single.html">Blueberry muffins</a>
                      </h5>
                      <p class="text-italic">
                        Big Blueberry muffins with a crusty sugar topping. The
                        blueberries and the sweet batter are fabulous and
                        taste amazing.
                      </p>
                      <p class="price">10.90</p>
                      <a
                ...
                <div class="item">
                  <div class="thumbnail-menu-modern">
                    ...
                    <div class="caption">
                      <h5>
                        <a class="link link-default" href="menu-single.html">Donuts</a>
                      </h5>
                      <p class="text-italic">
                        Homemade and filled with a delightful vanilla cream
                        pudding and topped with sweet white icing, these
                        donuts will delight you.
                      </p>
                      <p class="price">13.90</p>
                      <a
                        class="btn btn-shape-circle btn-burnt-sienna offset-top-15"
                ...
                <div class="item">
                  <div class="thumbnail-menu-modern">
                    ...
                    <div class="caption">
                      <h5>
                        <a class="link link-default" href="menu-single.html">Ice Cream</a>
                      </h5>
                      <p class="text-italic">
                        Our premium sweet-cream, classic vanilla ice cream is
                        pure pleasure. Perfect for sundaes, with a slice of
                        cake, or just heavenly when flying solo.
                      </p>
                      <p class="price">17.97</p>
                      <a
                        class="btn btn-shape-circle btn-burnt-sienna offset-top-15"
                ...
                <div class="item">
                  <div class="thumbnail-menu-modern">
                    ...
                    <div class="caption">
                      <h5>
                        <a class="link link-default" href="menu-single.html">Pancakes</a>
                      </h5>
                      <p class="text-italic">
                        Get the deliciousness of this all-American dish—in
                        half the time. Enjoy the unforgettable taste of our
                        pancakes!
                      </p>
                      <p class="price">25.00</p>
                      <a
                ...
                <div class="item">
                  <div class="thumbnail-menu-modern">
                    ...
                    <div class="caption">
                      <h5>
                        <a class="link link-default" href="menu-single.html">Chocolate Fudge Cake</a>
                      </h5>
                      <p class="text-italic">
                        Finished with chunks of chocolate brownie and served
                        with vanilla ice cream, this cake is a must if you
                        enjoy tasty desserts.
                      </p>
                      <p class="price">9.50</p>
                      <a
                        class="btn btn-shape-circle btn-burnt-sienna offset-top-15"
