              ...
              <div class="rd-navbar-inner">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="active"><a class="navbar-icon thin-icon-tag" href="#">News</a>
                    ...
                    <li><a class="navbar-icon thin-icon-layers" href="#features">Pages</a>
                      <!-- RD Navbar Megamenu-->
                      <ul class="rd-navbar-megamenu">
                        ...
                        <li>
                          <h6 class="rd-megamenu-header">Layouts</h6>
                          <ul class="list-marked">
                            <li><a href="index.html">Default Header</a></li>
                            <li><a href="index-corporate.html">Corporate Header</a></li>
                            <li><a href="index-sidebar.html">Sidebar Header</a></li>
                          </ul>
                        ...
                        <li>
                          <h6 class="rd-megamenu-header">Extra</h6>
                          <ul class="list-marked">
        ...
        <section class="section-50 section-sm-100">
          <div class="container">
            <div class="row justify-content-md-center justify-content-lg-end">
              <div class="col-md-9">
                ...
                <section>
                                  ...
                                  <article class="post post-classic">
                                    <!-- Post media--><img class="img-responsive" src="images/post-01-870x412.jpg" alt="" width="870" height="412">
                                    <!-- Post content-->
                                    <section class="post-content text-start offset-top-25">
                                      <h5><a class="link-default text-uppercase" href="blog-post.html">The History of Sandwiches</a></h5>
                                      <ul class="list-inline list-inline-md offset-top-5">
                                        <li>
                                          <div class="unit unit-horizontal unit-spacing-xxs">
                                            <div class="unit-left"><span class="text-base">Date:</span></div>
                                            <div class="unit-body">
                                              <time datetime="2021-01-01">January 22, 2021</time>
                                            </div>
                                          </div>
                                        </li>
                                        <li>
                                          <div class="unit unit-horizontal unit-spacing-xxs">
                                            ...
                                            <div class="unit-body"><a class="link link-gray-light" href="blog-post.html">John Doe</a></div>
                                          </div>
                                        </li>
                                        <li>
                                          <div class="unit unit-horizontal unit-spacing-xxs">
                                            <div class="unit-left"><span class="text-base">Comments:</span></div>
                                            <div class="unit-body"><a class="link link-gray-light" href="blog-post.html">2</a></div>
                                          </div>
                                        </li>
                                        <li>
                                          <div class="unit unit-horizontal unit-spacing-xxs">
                                            <div class="unit-left"><span class="text-base">Category:</span></div>
                                            <div class="unit-body"><a class="link link-gray-light" href="#">Toasts</a>
                                            </div>
                                          </div>
                                        </li>
                                      </ul>
                  ...
                  <div class="offset-top-60 offset-sm-top-100">
                                    <!-- Post Classic-->
                                    <article class="post post-classic">
                                      <!-- Post media--><img class="img-responsive" src="images/post-02-870x412.jpg" alt="" width="870" height="412">
                                      <!-- Post content-->
                                      <section class="post-content text-start offset-top-25">
                                        <h5><a class="link-default text-uppercase" href="blog-post.html">Making Tasty Thanksgiving Turkey Burgers</a></h5>
                                        <ul class="list-inline list-inline-md offset-top-5">
                                          <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                              <div class="unit-left"><span class="text-base">Date:</span></div>
                                          ...
                                          <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                              <div class="unit-left"><span class="text-base">Category:</span></div>
                                              <div class="unit-body"><a class="link link-gray-light" href="#">Burgers</a>
                                              </div>
                                            </div>
                                          </li>
                                        </ul>
                  ...
                  <div class="offset-top-60 offset-sm-top-100">
                                    <!-- Post Classic-->
                                    <article class="post post-classic">
                                      <!-- Post media--><img class="img-responsive" src="images/post-03-870x412.jpg" alt="" width="870" height="412">
                                      <!-- Post content-->
                                      <section class="post-content text-start offset-top-25">
              ...
              <div class="col-md-3 offset-top-100 offset-md-top-0">
                <!-- Section Blog Modern-->
                      ...
                      <div class="offset-top-30">
                        <div class="unit unit-horizontal unit-spacing-xs">
                          ...
                          <div class="unit-body"><a class="link-default" href="blog-post.html"> Classic American Burger is Available Now!</a>
                            <div>
                              <time datetime="2021">Feb 4, 2021</time> <span>/</span> <span>1 Comment</span>
                            </div>
                          </div>
                        </div>
                        <div class="unit unit-horizontal unit-spacing-xs offset-top-15">
                          ...
                          <div class="unit-body"><a class="link-default" href="blog-post.html"> 5 Classic NYC Burgers You Have to Eat</a>
                            <div>
                              <time datetime="2021">Feb 4, 2021</time> <span>/</span> <span>2 Comment</span>
                            </div>
                          </div>
                        </div>
                        <div class="unit unit-horizontal unit-spacing-xs offset-top-15">
                          ...
                          <div class="unit-body"><a class="link-default" href="blog-post.html"> Top 5 New Burgers from Our Chef</a>
                            <div>
                              <time datetime="2021">Feb 4, 2021</time> <span>/</span> <span>0 Comment</span>
                            </div>
                          </div>
                        </div>
                      </div>
